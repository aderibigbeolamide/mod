...
export class RemoveUnusedFeilds1737854129108 implements MigrationInterface {
    name = 'RemoveUnusedFeilds1737854129108'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "request_to_rent" ADD IF NOT EXISTS "property_id" uuid`);
        await queryRunner.query(`ALTER TABLE "request_to_rent" DROP COLUMN "unit_id"`);
        await queryRunner.query(`ALTER TABLE "request_to_rent" ADD IF NOT EXISTS "unit_id" uuid`);
    ...
    await queryRunner.query(`ALTER TABLE "request_to_rent" ADD COLUMN "unit_id" character varying`);

    await queryRunner.query(`ALTER TABLE "request_to_rent" DROP COLUMN IF EXISTS "property_id"`);
    await queryRunner.query(`ALTER TABLE "request_to_rent" ADD COLUMN "property_id" character varying`);
